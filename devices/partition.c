...
static void read_partition_table(struct block *, block_sector_t sector, block_sector_t primary_extended_sector,
                                 int *part_nr);
...
static void read_partition_table(struct block *block, block_sector_t sector, block_sector_t primary_extended_sector,
                                 int *part_nr)
{
...
static void found_partition(struct block *block, uint8_t part_type, block_sector_t start, block_sector_t size,
                            int part_nr)
{
